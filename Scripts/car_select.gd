...
var suv = {
	...
	"Kuro Fortress":["415 PP","Country: Japan","HP: 235","WEIGHT: 2560 KG","0-100 KM/H: 8.9s","TOP SPEED: 203 KM/H","ENGINE: V8 4.7L","TRANSMISSION: FOUR-WHEEL DRIVE"],
...
func _on_select_pressed():
	...
	Cars.save_color()   # ⭐ SAVE COLOR HERE ⭐
